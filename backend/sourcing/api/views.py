...
from .serializers import (
    ...
    ProspectImportSerializer, CampaignDetailSerializer
)
    ...
    def post(self, request, *args, **kwargs):
        ...
        for item in serializer.validated_data:
            ...
            if company:
                ...
                Company.objects.create(name=name, website=formatted_website)
                created_count += 1
...
class CreateCampaignView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response({"error": "Profil de sourcing introuvable."}, status=status.HTTP_404_NOT_FOUND)
